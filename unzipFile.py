                    ...
                    for i in range(1, len(password)):
                        ...
                        try:
                            ...
                            if(not estratto and i == (len(password) -1 )):
                                print("\nNon e' stata fornita la password per " + fileName + "\n")
                            else:
                                pass
                        if(not estratto):
                            print("\nNon sono riuscto ad estrarre " + fileName + "\n")
                        else:
                            print("\n" + fileName + " estratto con successo" + "\n")
                else:
                    print("\n" + fileName + " gia presente. Non sara estratto" + "\n")
            else:
                print("\nSono presenti dei .zip protetti. Inserire la password." + "\n")
                sys.exit()
        else:
            if(not checkIfFileIsAlreadyExtracted(fileName)):
                print("\nProvo a decomprimere " + fileName + "\n")
                try:
                    ...
                    if(not checkIfFileIsAlreadyExtracted(zip)):
                        ...
                        for i in range(1, len(password)):
                            ...
                            try:
                                ...
                                if(not estratto and i == (len(password) -1 )):
                                    print("\n" + "Non e' stata fornita la password per " + zip + "\n")
                                else:
                                    pass
                        if(not estratto):
                            print("\n" + "Non sono riuscto ad estrarre " + zip + "\n")
                        else:
                            print("\n" + zip + " estratto con successo" + "\n")
                    else:
                        print("\n" + zip + " gia presente. Non sara estratto" + "\n")
                else:
                    print("\n" + "Sono presenti dei .zip protetti. Inserire la password." + "\n")
                    sys.exit()
            else:
